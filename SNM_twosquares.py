...
B_lower_loop = B_points[B_points[:, 0] <= cutoff]  # Lower half of second sweep
...
upper_vertex_A, upper_vertex_B = find_max_distance_points(A_upper_loop, B_upper_loop)
lower_vertex_A, lower_vertex_B = find_max_distance_points(A_lower_loop, B_lower_loop)
...
upper_length = plot_square(upper_vertex_A, upper_vertex_B)
lower_length = plot_square(lower_vertex_A, lower_vertex_B)
SNM = min(upper_length, lower_length)  # Static Noise Margin
